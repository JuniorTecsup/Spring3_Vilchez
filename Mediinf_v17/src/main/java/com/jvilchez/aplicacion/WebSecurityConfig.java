...
public class WebSecurityConfig extends  WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/","/index","/api/login","/api/insertar","/signup","/enfermedades/lista","/enfermedades/nuevo","/enfermedades/crear","/enfermedades/editar/{id}","/enfermedades/actualizar","/enfermedades/borrar/{id}","/api/enfermedades","/api/enfermedad/{id}","/api/enfermedad/crear","/api/enfermedad/eliminar/{id}","/api/enfermedad/editar/{id}","auth/login").permitAll()
